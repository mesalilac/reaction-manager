 ...
 * ```
 */
export const IconWavyWarning = (props: IconProps) => {
    const [pickedProps, otherProps] = splitProps(props, ['size']);

    return (
        <svg
            role='img'
            aria-label='Wavy Warning'
